(function(E, A) {
    ...
    function S(a, b) {
        var d = {};
        c.each(na.concat.apply([], na.slice(0, b)),
        function() {
            d[this] = a
        });
        return d
    ...
    c = function() {
        ...
        b.fn = b.prototype = {
            ...
            pushStack: function(i, r, y) {
                ...
                if (r === "find") z.selector = this.selector + (this.selector ? " ": "") + y;
                        ...
                        for (b = b.split(" "); f = b[k++];) {
                            ...
                            if (B = G[f]) if (d) {
                                ...
                                if (B.length === 0 || e != null && B.length === 1) {
                                    if (!v.teardown || v.teardown.call(a, n) === false) c.removeEvent(a, f, w.handle);
                                    delete G[f]
                                }
    ...
    c.extend({
        ...
        cleanData: function(a) {
            ...
            (l = a[k]) != null; k++) if (! (l.nodeName && c.noData[l.nodeName.toLowerCase()])) if (d = l[c.expando]) {
                if ((b = e[d]) && b.events) for (var n in b.events) f[n] ? c.event.remove(l, n) : c.removeEvent(l, n, b.handle);
    ...
    c.extend({
        ...
        ajax: function(a) {
            ...
            if (w) {
                ...
                try {
                    if (b.data != null && !k || a && a.contentType) w.setRequestHeader("Content-Type", b.contentType);
                    if (b.ifModified) {
    ...
    tb = /^(?:toggle|show|hide)$/,
    ub = /^([+\-]=)?([\d+.\-]+)(.*)$/,
    aa, na = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
    c.fn.extend({
        show: function(a, b, d) {
            ...
            return this[f.queue === false ? "each": "queue"](function() {
                ...
                for (k in a) {
                    ...
                    if (l && (k === "height" || k === "width")) {
                        ...
                        if (c.css(this, "display") === "inline" && c.css(this, "float") === "none") if (c.support.inlineBlockNeedsLayout) if (oa(this.nodeName) === "inline") this.style.display = "inline-block";
                        else {
        ...
        step: function(a) {
            ...
            if (a || b >= this.options.duration + this.startTime) {
                ...
                if (d) {
                    ...
                    if (this.options.hide || this.options.show) for (var k in this.options.curAnim) c.style(this.elem, k, this.options.orig[k]);
    ...
    c.fn.extend({
        ...
        offsetParent: function() {
            return this.map(function() {
                for (var a = this.offsetParent || u.body; a && !Fa.test(a.nodeName) && c.css(a, "position") === "static";) a = a.offsetParent;
                return a
            })
        }
    });

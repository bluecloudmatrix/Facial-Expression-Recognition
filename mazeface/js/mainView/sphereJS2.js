...
window.Modernizr = function(a, b, c) {
    ...
    e._enableHTML5 = f,
    e._version = d,
    g.className = g.className.replace(/\bno-js\b/, "") + " " + u.join(" ");
    return e
} (this, this.document);
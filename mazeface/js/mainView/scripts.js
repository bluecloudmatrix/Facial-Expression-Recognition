var Slides = {
   ...
   loadContent : function() {
	  ...
	  $('<div id="#slide-0"></div>').load('helpView.html').appendTo( Slides.container );
	  $('<div id="#slide-1"></div>').load('mainView.html').appendTo( Slides.container );
	  $('<div id="#slide-2"></div>').load('optionView.html').appendTo( Slides.container );

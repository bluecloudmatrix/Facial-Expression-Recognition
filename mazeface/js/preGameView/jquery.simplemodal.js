(function(d) {
    ...
    d.modal.impl = {
        ...
        bindEvents: function() {
            var a = this;
            d("." + a.o.closeClass).bind("click.simplemodal",
            function(b) {
                b.preventDefault();
                a.close()
            });
            ...
            d(document).bind("keydown.simplemodal",
            function(b) {
            ...
            d(window).bind("resize.simplemodal",
            function() {
                f = a.getDimensions();
        ...
        fixIE: function() {
            var a = this,
            b = a.o.position;
            d.each([a.d.iframe || null, !a.o.modal ? null: a.d.overlay, a.d.container],
            function(c, h) {
                if (h) {
                    var g = h[0].style;
                    g.position = "absolute";
